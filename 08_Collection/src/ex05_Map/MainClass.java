...
public class MainClass {
	...
	public static void ex01() {
		...
		Map<String, Object> person = new HashMap<String, Object>(); // 뒤에 제네릭 스킵 가능!
		...
		// 수정
		// put(Key,Value)
		person.put("age", 40); //기존 Key와 동인한 key를 전달하면 해당 Key값의 Value가 수정된다.
		
		// 삭제
		// reMove(Key) 오브젝트에서 꺼낼 때 캐스팅 해주기
		// 삭제된 Value가 반환된다.
		//Value는 Object 타입이므로 캐스팅해야 사용할 수 있다.
	...
	public static void ex03() {
		...
		// Map 순회하기
		// Key만 가져오기가 가능하다 key값은 중복이 없기 때문에  set를 쓴다.(set는 중복된 값을 저장하지 않기 때문에)
		// key만 모두 가져온 뒤, 해당 key 값을 가진 Value를 가져오기
