...
public class Ex01_array {
	...
	public static void ex02() {
		...
		System.out.println(arr[0].length); // 1 번째 1차원 배열의 이름 
		System.out.println(arr[1].length); // 2 번째 1차원 배열의 이름 
		System.out.println(arr[2].length); // 3 번째 1차원 배열의 이름 
	...
	public static void ex04() { //초기화 하는 방법
