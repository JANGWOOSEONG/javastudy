...
public class MainClass {
	...
	/*
	 * 2023-01-04 오후 02:19 <DIR> bin 2023-01-04 오후 02:19 <DIR> conf 2023-01-04 오후
	 * 02:19 <DIR> include 2023-01-04 오후 02:19 <DIR> jmods 2023-01-04 오후 02:19 <DIR>
	 * legal 2023-01-04 오후 02:19 <DIR> lib 2023-01-04 오후 02:19 160 README.html
	 * 2023-01-04 오후 02:19 1,302 release 2개 파일 1,462 바이트
	 */
	public static void ex02() {

		File dir = new File(
				"C:" + File.separator + "Program Files" + File.separator + "Java" + File.separator + "jdk-11.0.17");
	...
	public static void ex03() {
		...
		/*
		 * 저장된 파일이 myfile.txt 뿐이라는 걸 알고 있어서 이런 코드가 나왔죠. File file = new File(dir,
		 * "myfile.txt"); if(file.exists()) { file.delete(); }
		 */
	...
	public static void ex04() {
		...
		try (PrintWriter out = new PrintWriter(file)) {
			...
			System.out.println("diart.txt 파일이 생성되었다");
	...
	// 예외가 발생한 경우 예외 메시지와 예외 발생시간을 저장한 C:\storage\log.txt
	...
	// 문제7. System.in은 키보드로부터 바이트 데이터를 입력 받는 InputStream 입니다.
	...
	public static void ex08() {
		...
		String sep = File.separator;
		File from = new File("C:" + sep + "GDJ61"+ sep + "installer" + sep , "연습.txt");		
