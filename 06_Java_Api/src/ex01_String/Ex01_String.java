...
public class Ex01_String {
	...
	public static void equals() {
		...
		if(str1.equals(str2)) {
			System.out.println("str1과 str1는 같은 문자열이다.");
		} else {
			System.out.println("str1과 str1는 다른 문자열이다.");
	...
	public static void substring() {
		...
		// 2. substring(int begin, int end) : 인덱스 begin부터 end 이전까지 반환(begin <= 추출범위 < 
	...
	public static void indexof() {
		...
		// 2. indexOf(String str, int index) : 지정한 인덱스 index부터 str을 검색
	...
	public static void lastIndexOf() {
		...
		int idx2 = slogan.lastIndexOf("장우성");
	...
	public static void startsWith() {
		...
		if(name.startsWith("장")) {
			System.out.println("장씨다.");
		}else {
			System.out.println("장씨가 아니다.");
		}
	}
	...
	public static void contains() {
		...
		// contains
		// 문자열이 지정된 CharSequence를(String, char[] 등)를 포함하면 true 반환
		
		// 참고
		// public interface CharSequence { }
		// public class String implements CharSequence { }
		
		String email = "wkddntjd1222@naver.com";
	...
	public static void trim() {
		//trim
		//문자열의 앞뒤에 포함된 공백 문자를 제거(스페이스, 탭, 엔터 등)를 제거
	...
	public static void format() {
		...
		// 숫자 형식 지정하기
		int number = 1000;
		System.out.println(String.format("%o", number)); // %0 : 8진수로 표시하시오.
		System.out.println(String.format("%d", number)); // %d : 10진수로 표시하시오.
		System.out.println(String.format("%x", number)); // %x : 16진수로 표시하시오.(0~9,a,b,c,d,e,f,)(x가 소문자면 소문자)
		System.out.println(String.format("%X", number)); // %X : 16진수로 표시하시오.(0~9,A,B,C,D,E,F,)(X가 대문자면 대문자)
		...
		System.out.println(String.format("%5s", str)); //%5d : 5자리로 표시하시오. 숫자는 오른쪽에 표시하시오
		System.out.println(String.format("%-5s", str)); //%-5d : 5자리로 표시하시오. 숫자는 왼쪽에 표시하시오
