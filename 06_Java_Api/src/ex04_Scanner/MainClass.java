...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		/*
		  java.util.Scanner              최종프로젝트에는 쓰지않는다
		...
		System.out.print("입력된 키는 " + height + "cm입니다.");
		
		// char 입력
		System.out.print("성별은 무엇인가요? (남/여) >>> ");
		char gendar = sc.next().charAt(0);
		System.out.print("입력된 성별은 " + gendar + "입니다.");
