...
import java.util.List;
		...
		public static void ex02() {
			...
			System.out.println("ex02.bin 파일의 크기 : " + file.length() + "byte");
	}
		...
		public static void ex03() {
			...
			System.out.println("ex03.bin 파일의 크기 : " + file.length() + "byte");
			}
		}
		...
		public static void ex04() {
			...
			System.out.println("ex04.bin 파일의 크기 : " + file.length() + "byte");
		}
		...
		public static void ex05() {
			...
			System.out.println("ex05.dat 파일의 크기 : " + file.length() + "byte");
		}
