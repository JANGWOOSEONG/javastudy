...
public class MainClass {
	...
	public static void ex02() {
		...
		try {
			...
			int readByte = 0; // 실제로 읽은 바이트 를 저장해 두시오.
			StringBuilder sb = new StringBuilder();
	...
	public static void ex02complete() {
		...
		try {
			...
			int readCount = 0; // 실제로 읽은 바이트 를 저장해 두시오.
			StringBuilder sb = new StringBuilder();
	...
	public static void ex03complete() {
	...
	public static void ex04() {
		...
		//String name, int age, double height, boolean isAlive 순으로 값이 저장된ex04.dat파일
